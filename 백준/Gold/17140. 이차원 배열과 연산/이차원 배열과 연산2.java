...
/**
 * <BJ_17140_이차원배열과연산>
 * 2. 처음부터 arr[100][100]으로 선언하고 시작한 방법 (100초까지만 가능하므로)
 * 
...
public class Main {
	...
	static int k;
	static int[][] arr;
	static int rowLen = 3; // 숫자가 채워지는 행의 길이
	static int colLen = 3; // 숫자가 채워지는 열의 길이
	...
	public static void main(String[] args) throws IOException {
		...
		while(true) {
			...
			if(rowLen >= colLen) { // 행의 개수 >= 열의 개수 : R연산
				operationR();
