 ...
 * 
 * 방문배열 사용하지 않으면 메모리 초과!!!
 * 최대 7자리의 숫자를 모든 경우에 대해서 swap하는 것을 10번 반복하므로
 * visited[1000001][K+1] 을 사용하면 최대 1000000 * 10 이므로 ok!!
 * 
 * 처음에는 정렬을 직접 구현했는데 잘 안되서 답 참고했음 ㅜㅜ
 * 이 문제를 bfs처럼 풀 거라고는 생각도 못함..! ㄷㄷ 분발하자ㅜㅜ
 * 
 * @author YooSejin
 *
 */
